# 1. Screen Overview
Screen ID: ANL-002
Name: Inbound vs Outbound Trend Analysis
Primary Persona: Operations Manager, Planner
...
- Filter by warehouse/product family/shift
- Toggle volume vs value
- Export trend chart
🟡 Secondary (visible but less prominent)
- Daily/weekly inbound and outbound quantities
- Net movement and imbalance trend
- Peak load periods
