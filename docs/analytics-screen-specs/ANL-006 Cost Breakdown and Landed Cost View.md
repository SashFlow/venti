# 1. Screen Overview
Screen ID: ANL-006
Name: Cost Breakdown and Landed Cost View
Primary Persona: Finance Analyst
...
- Expand landed cost components
- Compare supplier lanes
- Flag abnormal cost spikes
🟡 Secondary (visible but less prominent)
- Base/freight/insurance/customs costs
- Cost per unit trend
