# 1. Screen Overview
Screen ID: ANL-007
Name: Stock Aging Dashboard
Primary Persona: Inventory Controller, Planner
...
- Filter age buckets
- Focus FEFO-risk SKUs
- Trigger replenishment or clearance action
🟡 Secondary (visible but less prominent)
- Quantity and value by age band
- Expiry risk horizon
- Movement recency
