# 1. Screen Overview
Screen ID: ADM-005
Name: UOM and Conversion Admin
Primary Persona: Master Data Admin
...
- Define UOM hierarchy
- Set conversion factors
- Set precision and rounding rules
🟡 Secondary (visible but less prominent)
- Base UOM and alternate UOMs
- Effective dates
- Validation and conflict logs
