# 1. Screen Overview
Screen ID: WEB-007
Name: Pick Performance Monitor
Primary Persona: Warehouse Supervisor

Goal of Screen (1 line): Support reliable and fast execution of Pick Performance Monitor workflows.
...
Main CTA: Complete Pick Performance Monitor
...
- Track active waves
- Compare picker productivity
- Trigger help for lagging tasks
