# 1. Screen Overview
Screen ID: WEB-020
Name: QC Operations Queue
Primary Persona: QC Supervisor

Goal of Screen (1 line): Support reliable and fast execution of QC Operations Queue workflows.
...
Main CTA: Complete QC Operations Queue
