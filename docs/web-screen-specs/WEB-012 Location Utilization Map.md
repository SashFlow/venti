# 1. Screen Overview
Screen ID: WEB-012
Name: Location Utilization Map
Primary Persona: Inventory Controller, Operations Manager

Goal of Screen (1 line): Support reliable and fast execution of Location Utilization Map workflows.
...
Main CTA: Complete Location Utilization Map
...
- Filter by zone class
- Open bin details
🟡 Secondary (visible but less prominent)
- Occupancy percent by location
- Constraint violations
- Fast/slow movement alignment
