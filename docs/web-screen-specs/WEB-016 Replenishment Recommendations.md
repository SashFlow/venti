...
Primary Persona: Planner, Inventory Controller

Goal of Screen (1 line): Support reliable and fast execution of Replenishment Recommendations workflows.
...
Main CTA: Complete Replenishment Recommendations
...
- Review suggested buys/transfers
- Adjust proposal quantities
- Approve and create document
🟡 Secondary (visible but less prominent)
- Forecast demand window
