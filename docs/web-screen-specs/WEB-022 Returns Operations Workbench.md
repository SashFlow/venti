# 1. Screen Overview
Screen ID: WEB-022
Name: Returns Operations Workbench
Primary Persona: Returns Supervisor

Goal of Screen (1 line): Support reliable and fast execution of Returns Operations Workbench workflows.
...
Main CTA: Complete Returns Operations Workbench
...
- Create return intake batch
- Link SRN and receipt
- Route to QC or disposition
🟡 Secondary (visible but less prominent)
- Return category and cause
- Item condition summary
- Credit-note eligibility
