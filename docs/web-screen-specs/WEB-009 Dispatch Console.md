...
Primary Persona: Dispatch Supervisor

Goal of Screen (1 line): Support reliable and fast execution of Dispatch Console workflows.
...
Main CTA: Complete Dispatch Console
