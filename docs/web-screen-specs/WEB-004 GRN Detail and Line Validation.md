# 1. Screen Overview
Screen ID: WEB-004
Name: GRN Detail and Line Validation
Primary Persona: Operations Supervisor

Goal of Screen (1 line): Support reliable and fast execution of GRN Detail and Line Validation workflows.
...
Main CTA: Complete GRN Detail and Line Validation
...
- Validate lines in bulk
- Apply serial/lot edits
- Approve over/short exception
🟡 Secondary (visible but less prominent)
- PO line vs received quantities
- Variances by SKU
- Audit trail of line edits
