# 1. Screen Overview
Screen ID: WEB-003
Name: Inbound Workbench
Primary Persona: Operations Supervisor

Goal of Screen (1 line): Support reliable and fast execution of Inbound Workbench workflows.
...
Main CTA: Complete Inbound Workbench
...
- Create GRN from ASN/PO
- Start receiving session
- Route lines to QC
🟡 Secondary (visible but less prominent)
- Expected arrivals and dock assignments
