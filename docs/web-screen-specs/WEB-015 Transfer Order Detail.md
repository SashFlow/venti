...
Goal of Screen (1 line): Support reliable and fast execution of Transfer Order Detail workflows.
...
Main CTA: Complete Transfer Order Detail
...
- Edit transfer lines
- Confirm dispatch/receipt milestones
- Raise discrepancy case
🟡 Secondary (visible but less prominent)
- Planned vs moved vs received
- Transit timeline
- Exception logs
