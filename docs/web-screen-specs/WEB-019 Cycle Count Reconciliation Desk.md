# 1. Screen Overview
Screen ID: WEB-019
Name: Cycle Count Reconciliation Desk
Primary Persona: Inventory Controller, Supervisor

Goal of Screen (1 line): Support reliable and fast execution of Cycle Count Reconciliation Desk workflows.
...
Main CTA: Complete Cycle Count Reconciliation Desk
...
- Book vs count vs recount
- Variance value and threshold
