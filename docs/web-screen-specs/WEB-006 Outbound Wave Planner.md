# 1. Screen Overview
Screen ID: WEB-006
Name: Outbound Wave Planner
Primary Persona: Warehouse Supervisor

Goal of Screen (1 line): Support reliable and fast execution of Outbound Wave Planner workflows.
...
Main CTA: Complete Outbound Wave Planner
...
- Create wave by rules
- Simulate wave impact
- Release/cancel wave
🟡 Secondary (visible but less prominent)
- Candidate orders by cutoff
- Picker availability
