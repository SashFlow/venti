# 1. Screen Overview
Screen ID: WEB-005
Name: Putaway Monitor
Primary Persona: Operations Supervisor

Goal of Screen (1 line): Support reliable and fast execution of Putaway Monitor workflows.
...
Main CTA: Complete Putaway Monitor
...
- View pending putaway queue
- Recompute bin suggestions
- Reassign tasks by zone
🟡 Secondary (visible but less prominent)
- Suggested location confidence
