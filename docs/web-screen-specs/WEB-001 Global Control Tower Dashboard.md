# 1. Screen Overview
Screen ID: WEB-001
Name: Global Control Tower Dashboard
Primary Persona: Operations Manager, Supervisor

Goal of Screen (1 line): Support reliable and fast execution of Global Control Tower Dashboard workflows.
...
Main CTA: Complete Global Control Tower Dashboard
...
- Switch warehouse scope
- Apply date and shift filters
- Drill into exceptions
🟡 Secondary (visible but less prominent)
- Inbound/outbound throughput
- Open tasks by status
- SLA breaches and risk forecast
- OTIF and fulfillment trend
