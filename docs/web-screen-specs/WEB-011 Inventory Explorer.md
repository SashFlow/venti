...
Primary Persona: Inventory Controller

Goal of Screen (1 line): Support reliable and fast execution of Inventory Explorer workflows.
...
Main CTA: Complete Inventory Explorer
...
- Search SKU/location/lot/serial
- Apply stock state filters
- Export filtered inventory snapshot
🟡 Secondary (visible but less prominent)
- On-hand/available/reserved
- Age buckets and expiry risk
