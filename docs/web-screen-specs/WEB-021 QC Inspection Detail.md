# 1. Screen Overview
Screen ID: WEB-021
Name: QC Inspection Detail
Primary Persona: QC Inspector

Goal of Screen (1 line): Support reliable and fast execution of QC Inspection Detail workflows.
...
Main CTA: Complete QC Inspection Detail
...
- Template sections and pass/fail
- Defect taxonomy
- Disposition impact preview
