# 1. Screen Overview
Screen ID: WEB-002
Name: Task Orchestration Board
Primary Persona: Operations Supervisor

Goal of Screen (1 line): Support reliable and fast execution of Task Orchestration Board workflows.
...
Main CTA: Complete Task Orchestration Board
...
- Pause or unblock tasks
🟡 Secondary (visible but less prominent)
- Task cards by stage
- Owner/start/SLA timer
- Dependency blockers
