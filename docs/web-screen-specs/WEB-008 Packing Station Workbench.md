# 1. Screen Overview
Screen ID: WEB-008
Name: Packing Station Workbench
Primary Persona: Packing Operator, Supervisor

Goal of Screen (1 line): Support reliable and fast execution of Packing Station Workbench workflows.
...
Main CTA: Complete Packing Station Workbench
...
- Record dimensional weight
🟡 Secondary (visible but less prominent)
- Order lines and picked status
