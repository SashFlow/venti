# 1. Screen Overview
Screen ID: WEB-024
Name: Clearance and Write-Off Console
Primary Persona: Operations Manager, Finance

Goal of Screen (1 line): Support reliable and fast execution of Clearance and Write-Off Console workflows.
...
Main CTA: Complete Clearance and Write-Off Console
