# 1. Screen Overview
Screen ID: WEB-023
Name: Dead Stock Analyzer
Primary Persona: Inventory Controller, Finance Analyst

Goal of Screen (1 line): Support reliable and fast execution of Dead Stock Analyzer workflows.
...
Main CTA: Complete Dead Stock Analyzer
...
- Filter by aging bands
- Segment by warehouse/category
