...
Goal of Screen (1 line): Support reliable and fast execution of Exception Command Center workflows.
...
Main CTA: Complete Exception Command Center
...
- Exception source trends
- Open vs resolved aging
