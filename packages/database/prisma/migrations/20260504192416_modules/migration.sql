...
-- AddForeignKey
ALTER TABLE "public"."note" ADD CONSTRAINT "note_noteTagId_fkey" FOREIGN KEY ("noteTagId") REFERENCES "public"."note_tag"("id") ON DELETE CASCADE ON UPDATE CASCADE;
